...
function update(elapsedTime) {
  ...
  if(HasLost)
  {
	...
	drawImageCentered(g_ctx, images.outOfInk.img, g_canvas.width / 2, g_canvas.height / 3 - 150);
	drawImageCentered(g_ctx, images.playAgain.img, g_canvas.width / 2, g_canvas.height / 3 + 100);
  }
